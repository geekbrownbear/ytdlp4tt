...
1. Get your Account Data from TikTok (example file `user_data_tiktok.json`). From [TikTok KB](https://support.tiktok.com/en/account-and-privacy/personalized-ads-and-data/requesting-your-data) (You can download "All" data or just "Activity" which doesn't include shared videos):
